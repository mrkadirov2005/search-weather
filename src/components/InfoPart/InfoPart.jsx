...
let currentCountry=useSelector(getCurrentCountry) 
  ...
  let name=info.weather.weatherInfo.location.name
  let region=info.weather.weatherInfo.location.region
  ...
  let type=info.weather.type
        ...
        <MainContainer>
            <div className='box_part'>
              <h2 className='location_style'>{name} in {region}<img src={info.weather.weatherInfo.current.condition.icon} /> </h2>
